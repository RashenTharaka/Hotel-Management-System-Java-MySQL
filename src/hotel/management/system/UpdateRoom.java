        ...
        if (ae.getSource() == check) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    UITheme.showMessageDialog(null, "Room not found!");
            ...
            if(price.equals("")){
             UITheme.showMessageDialog(null, "Price Should Not Be Empty!");
            ...
            try {
                Conn c = new Conn();
                String updateQuery = "UPDATE room SET availability = ?, cleaning_status = ?, price = ? WHERE roomnumber = ?";
                ...
                UITheme.showMessageDialog(null, "Room Details Updated Successfully");
            ...
            int confirm = UITheme.showConfirmDialog(this, "Are you sure you want to delete Room " + room + "?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    Conn c = new Conn();
                    String deleteQuery = "DELETE FROM room WHERE roomnumber = ?";
                    PreparedStatement deleteStmt = c.c.prepareStatement(deleteQuery);
                    deleteStmt.setString(1, room);
                    deleteStmt.executeUpdate();

                    UITheme.showMessageDialog(null, "Room Deleted Successfully");
