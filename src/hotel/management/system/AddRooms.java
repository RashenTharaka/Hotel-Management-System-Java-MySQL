   ...
   public void actionPerformed(ActionEvent ae){
       if (ae.getSource()== add){
           ...
           if (!roomnumber.matches("\\d{3}")) {  
            UITheme.showMessageDialog(null, "Room number must be exactly 3 digits!", "Error", JOptionPane.ERROR_MESSAGE);
            return; 
        }
           if(price.equals("")){
           ...
           try {
            ...
            if (rs.next() && rs.getInt(1) > 0) {
                UITheme.showMessageDialog(null, "Room number already exists!", "Error", JOptionPane.ERROR_MESSAGE);
                return; 
            }
            ...
            UITheme.showMessageDialog(null, "New Room Added Successfully");
