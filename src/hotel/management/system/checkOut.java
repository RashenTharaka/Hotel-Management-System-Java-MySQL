...
public class checkOut extends javax.swing.JFrame {
    ...
    private void btncheckoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncheckoutActionPerformed
        ...
        if (!cbpaid.isSelected()) {
            UITheme.showMessageDialog(this, "Please confirm payment by ticking the 'Paid' checkbox before checkout.");
            return;
        }
        ...
        if (selectedID == null || roomNo.isEmpty()) {
            UITheme.showMessageDialog(this, "Please select a customer.");
            return;
        }
        ...
        try {
            ...
            try {
                ...
                // Make the room available again after checkout
                String updateRoomQuery = "UPDATE room SET availability = ?, cleaning_status = ? WHERE roomnumber = ?";
                PreparedStatement updateRoomStmt = conn.prepareStatement(updateRoomQuery);
                updateRoomStmt.setString(1, "Available");
                updateRoomStmt.setString(2, "Dirty");
                updateRoomStmt.setString(3, roomNo);
                updateRoomStmt.executeUpdate();

                conn.commit();
                UITheme.showMessageDialog(this, "Customer checked out successfully!");
                ...
                e.printStackTrace();
                UITheme.showMessageDialog(this, "Checkout failed: " + e.getMessage());
            ...
            UITheme.showMessageDialog(this, "Invalid check-in time format. Please use yyyy-MM-dd HH:mm:ss.");
        }
    ...
    private void CustIDComboBoxActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            e.printStackTrace();
            UITheme.showMessageDialog(this, "Failed to load customer details: " + e.getMessage());
        }
