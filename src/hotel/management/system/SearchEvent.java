...
public class SearchEvent extends JFrame implements ActionListener {
    ...
    public SearchEvent() {
        ...
        UITheme.centerFeatureWindow(this, 1000, 650);
    ...
    private void searchEvent() {
        ...
        if (!eventnumber.isEmpty()) {
            ...
            if (!eventnumber.matches("\\d+") || Integer.parseInt(eventnumber) <= 0) {
                UITheme.showMessageDialog(null, "Enter a valid positive integer for Event Number!", "Input Error", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    UITheme.showMessageDialog(null, "Event Not Found!", "Search Result", JOptionPane.INFORMATION_MESSAGE);
        ...
        // Search by date   
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    UITheme.showMessageDialog(null, "No events found for the selected date.", "Search Result", JOptionPane.INFORMATION_MESSAGE);
                    ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to search event ( Event no: " + eventnumber + ")", "Not Found");
                    clearFields();
                }
            ...
            UITheme.showMessageDialog(null, "Please enter Event Number or select a Date to search.", "Input Required", JOptionPane.WARNING_MESSAGE);
            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to search event ( Event no: " + eventnumber + ")", "Failed");
        }
    ...
    private void updateEvent() {
        ...
        if (selectedHour == null || selectedMinute == null || selectedHour.isEmpty() || selectedMinute.isEmpty()) {
            UITheme.showMessageDialog(null, "Please select both hour and minute for duration!", "Input Error", JOptionPane.ERROR_MESSAGE);
        ...
        if (durHour.equals("0") && durMinute.equals("00")) {
                            UITheme.showMessageDialog(null, "Duration cannot be 0!", "Input Error", JOptionPane.ERROR_MESSAGE);
                            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to update event ( Event no: " + eventnumber + ")", "Failed");
                            return;
                        }
        ...
        if (eventnumber.isEmpty() || description.isEmpty() || selectedDate == null || duration.isEmpty()) {
            UITheme.showMessageDialog(null, "Please fill all fields before updating!", "Update Error", JOptionPane.ERROR_MESSAGE);
            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to update event ( Event no: " + eventnumber + ")", "Failed");
            return;
        }
        ...
        try {
            ...
            if (rs.next()) {
                UITheme.showMessageDialog(null, "The selected date is already reserved for another event. Please choose another date.", "Date Reserved", JOptionPane.ERROR_MESSAGE);
            ...
            if (rowsAffected > 0) {
                UITheme.showMessageDialog(null, "Event Updated Successfully!", "Update Success", JOptionPane.INFORMATION_MESSAGE);
                ...
                UITheme.showMessageDialog(null, "Event Update Failed!", "Update Error", JOptionPane.ERROR_MESSAGE);
                ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to update event ( Event no: " + eventnumber + ")", "Failed");
            }
        } catch (SQLException e) {
            e.printStackTrace();
            UITheme.showMessageDialog(null, "Error occurred while updating event.", "Update Error", JOptionPane.ERROR_MESSAGE);
            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to update event ( Event no: " + eventnumber + ")", "Failed");
        }
    }
    ...
    private void deleteEvent() {
        ...
        int confirm = UITheme.showConfirmDialog(null, "Are you sure you want to delete this event?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
        ...
        try {
            ...
            if (rowsAffected > 0) {
                UITheme.showMessageDialog(null, "Event Deleted Successfully!", "Delete Success", JOptionPane.INFORMATION_MESSAGE);
                ...
                UITheme.showMessageDialog(null, "Event Not Found!", "Delete Failed", JOptionPane.ERROR_MESSAGE);
            ...
            e.printStackTrace();
            UITheme.showMessageDialog(null, "Error occurred while deleting the event.", "Delete Error", JOptionPane.ERROR_MESSAGE);
            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to delete event ( Event no: " + eventnumber + ")", "Failed");
        }
    }
    ...
    private void generateReport() {
        try {
            ...
            UITheme.showMessageDialog(null, "PDF report generated successfully!");
            ActivityLogger.log(Session.loggedNIC, Session.loggedName, Session.loggedRole,"Attempted to genarate event report", "Success");

        } catch (Exception e) {
            e.printStackTrace();
            UITheme.showMessageDialog(null, "Error generating report!");
